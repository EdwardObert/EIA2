//Dieser Code basiert auf der Abgabe der Aufgabe 4 von Matej Sulfrian & ich hab die Aufgabe mit Hilfe von Dominik gelöst.
...
namespace L05_Haushaltshilfe {
    ...
    async function sendOrder(_event: Event): Promise<void> {
        ...
        console.log("Order verschickt");

        let formData: FormData = new FormData(form);
        let query: URLSearchParams = new URLSearchParams(<any>formData);
        await fetch("Haushalthilfe.html?" + query.toString());
